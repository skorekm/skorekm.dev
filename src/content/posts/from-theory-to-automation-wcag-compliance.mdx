...
const sitemapPath = path.resolve(process.cwd(), '.next/server/app/sitemap.xml.body');
    ...
    steps:
      ...
      - name: Cache Next.js build
        ...
        with:
          ...
          key: |
            ${{ runner.os }}-nextjs-v1-${{ hashFiles('**/package-lock.json', 'next.config.js') }}
          restore-keys: |
            ${{ runner.os }}-nextjs-v1-${{ hashFiles('**/package-lock.json') }}
            ${{ runner.os }}-nextjs-v1-
      ...
      - name: Install axe-core CLI
        run: npm install -g @axe-core/cli && npx browser-driver-manager install chrome
